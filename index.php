...
?>
                        ...
                        <div class="landing-how__wrap">
                            <div class="landing-how__item">
                                ...
                                <div class="landing-how__info">
                                    <a href="#form" data-effect="mfp-zoom-in">
                                        <?
                                        $APPLICATION->IncludeComponent(
                                            ...
                                            array(
                                                ...
                                                "ADD_HREF_LINK" => "Y",
                                                "ALX_LINK_POPUP" => "Y",
                                                "BBC_MAIL" => "ilia.klimko@yandex.ru",
                                                ...
                                                "EVENT_TYPE" => "ALX_ENTRY_FORM_SEND_MAIL",
                                                "FB_TEXT_NAME" => "",
                                                ...
                                                "MESSAGE_OK" => "Спасибо, в ближайшее время с Вами свяжутся специалисты регистрационного центра и подберут удобные для Вас день и время визита.",
                                                ...
                                                "SECTION_MAIL_ALL" => "ilia.klimko@yandex.ru",
                                                "SEND_IMMEDIATE" => "N",
                                                "SEND_MAIL" => "N",
    ...
    <div id="form" class="popup popup--landing mfp-with-anim mfp-hide">
        <h3>Подключить МТС Бизнес-рассылки</h3><br>
        <form action="#" method="post" id="popup-form">
            <div class="page-form__top">
                ...
                <div class="checkbox-item">
                    <input type="checkbox" id="popup-checkbox1" name="checkbox" checked="">
                    <label for="popup-checkbox1">
                        Даю согласие на обработку моих персональных данных в порядке, установленном законодательством Республики Беларусь
                    </label>
                </div>
                <input type="submit" value="Оставить заявку" class="btn"><br><br>
                <a href="#success" class="js-popup-inline" data-effect="mfp-zoom-in">Сообщение об отправке</a>
            </div>
        </form>
    </div>

    <div id="success" class="popup popup--landing mfp-with-anim mfp-hide">
